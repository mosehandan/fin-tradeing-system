...
{    
    ...
    public: 
        ...
        MdServer() : m_trade_date(-1), m_time_tol(0), m_pub(nullptr), m_id(""), m_calendar(nullptr), m_maptables(nullptr) {}
    ...
    protected:          
        bool do_publish(jzs::msg::md::MarketDataType type, const jzs::msg::md::MarketQuote& quote, uint32_t jzcode);        
        bool quotes_equal(const jzs::msg::md::MarketQuote& quote, const jzs::msg::md::MarketQuote& last_quote);
    ...
    protected:
        ...
        virtual void publish(jzs::msg::md::MarketDataType type, const jzs::msg::md::MarketQuote& bk);

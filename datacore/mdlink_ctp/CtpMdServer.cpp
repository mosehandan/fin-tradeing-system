...
CtpMdServer::CtpMdServer() { reqid = 0; userapi = NULL; }
...
void CtpMdServer::Start() { new thread(&CtpMdServer::Run, this); }
...
void CtpMdServer::OnRspError(CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) { IsErrorRspInfo(pRspInfo); }

void CtpMdServer::OnFrontDisconnected(int nReason) { LOG(ERROR) << "Disconect from ctp front."
								<< " Reason code " << nReason; }

void CtpMdServer::OnHeartBeatWarning(int nTimeLapse) { LOG(WARNING) << "Receive ctp Heartbeat timeout."; }
...
void CtpMdServer::OnRspUserLogin(CThostFtdcRspUserLoginField* pRspUserLogin, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast)
{
...
void CtpMdServer::OnRspSubMarketData(CThostFtdcSpecificInstrumentField* pSpecificInstrument, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {}

void CtpMdServer::OnRspUnSubMarketData(CThostFtdcSpecificInstrumentField* pSpecificInstrument, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {}
...
void CtpMdServer::OnRtnDepthMarketData( CThostFtdcDepthMarketDataField* pd)
{
    MarketQuote bk;

...
***********************************************************************/
#ifndef JZS_CTPMDSERVER_HPP
#define JZS_CTPMDSERVER_HPP
...
private:
    virtual void Start() { new thread(&CtpMdServer::Run, this); }
    ...
    virtual void OnRspError(CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) { IsErrorRspInfo(pRspInfo); }

    inline virtual void OnFrontDisconnected(int nReason) { LOG(ERROR) << "Disconect from ctp front."
								      << " Reason code " << nReason; }

    inline virtual void OnHeartBeatWarning(int nTimeLapse) { LOG(WARNING) << "Receive ctp Heartbeat timeout."; }
    ...
    inline virtual void OnRspSubMarketData(CThostFtdcSpecificInstrumentField* pSpecificInstrument, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {}

    inline virtual void OnRspUnSubMarketData(CThostFtdcSpecificInstrumentField* pSpecificInstrument, CThostFtdcRspInfoField* pRspInfo, int nRequestID, bool bIsLast) {}

    inline virtual void OnRtnDepthMarketData(CThostFtdcDepthMarketDataField* pd)
    {
	MarketQuote bk;
